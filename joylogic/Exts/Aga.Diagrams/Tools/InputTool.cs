...
namespace Aga.Diagrams.Tools
{
    public class InputTool : IInputTool
    {
        ...
        {
            //MouseDownItem = e.Source as Node;
            MouseDownItem = (e.OriginalSource as DependencyObject).FindParent<DiagramItem>();
            //var item = (e.OriginalSource as DependencyObject).FindParent<DiagramItem>();
            //if (item != null)
            //{
            //    MouseDownItem = item.FindChild(e.GetPosition(item));
            //}
            //else
            //{
            //    MouseDownItem = null;
