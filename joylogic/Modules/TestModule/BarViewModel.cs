...
namespace TestModule
{
    public class BarViewModel : BaseViewModel
    {
        ...
        public BarViewModel(TestContext testContext,IRegionManager regionManager, IEventAggregator eventAggregator, ISysNavigationService sysNavigationService, CurrentContextSessionService userSessionService, ILoggerFacade logger)
        {
        ...
        protected override IReadOnlyCollection<Core.Infrastructure.Controls.IconTextDelegateCommand<string>> GetToolBarCommands()
        {
            ...
            {
                this.testContext.TestBoolValue = false;
                this.Intent.Finsh();
            }));
